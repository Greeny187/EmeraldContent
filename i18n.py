...
TRANSLATIONS = {
    ...
    'en': {
        ...
        'CHANNEL_STATS_MENU':    '📊 Stats',
        'CHANNEL_SETTINGS_MENU': '⚙️ Settings',
        'CHANNEL_BROADCAST_MENU': '📝 Broadcast',
        'CHANNEL_PINS_MENU':     '📌 Pinned',
    ...
    'fr': {
        ...
        'CHANNEL_STATS_MENU':    '📊 Statistiques',
        'CHANNEL_SETTINGS_MENU': '⚙️ Paramètres',
        'CHANNEL_BROADCAST_MENU': '📝 Diffusion',
        'CHANNEL_PINS_MENU':     '📌 Épinglés',
        'CHANNEL_SWITCH':        '🔄 Changer de canal',
        'BACK':                  '🔙 Retour',
    ...
    'ru': {
        'CHANNEL_MENU_HEADER':   '🔧 Управление каналом «{title}» – выберите действие:',
        'CHANNEL_STATS_MENU':    '📊 Статистика',
        'CHANNEL_SETTINGS_MENU': '⚙️ Настройки',
        'CHANNEL_BROADCAST_MENU': '📝 Трансляция',
        'CHANNEL_PINS_MENU':     '📌 Закреплённые',
        'CHANNEL_SWITCH':        '🔄 Сменить канал',
        'BACK':                  '🔙 Назад',
